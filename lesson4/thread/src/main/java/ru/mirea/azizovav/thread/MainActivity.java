package ru.mirea.azizovav.thread;
...
import ru.mirea.azizovav.thread.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainThread.setName("\nМОЙ НОМЕР ГРУППЫ: 4, НОМЕР ПО СПИСКУ: 1, МОЙ ЛЮБИИМЫЙ ФИЛЬМ: Бойцовский клуб");
