package ru.mirea.azizovav.yandexdriver;
...
import ru.mirea.azizovav.yandexdriver.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements UserLocationObjectListener, DrivingSession.DrivingRouteListener {
    ...
    private final static Point CM_LOCATION = new Point(55.766749, 37.624211);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listener = new MapObjectTapListener() {
            ...
            public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point point) {
                Toast.makeText(getApplication(),"Central Market", Toast.LENGTH_SHORT).show();
                return false;
            }
        };
        marker = mapObjects.addPlacemark(CM_LOCATION);
        marker.addTapListener(listener);
        marker.setVisible(true);
        marker.setText("Central Market");
    }
    @Override
        ...
        mapKit.createLocationManager().requestSingleUpdate(new LocationListener() {
            ...
            public void onLocationUpdated(@NonNull Location location) {
                binding.customMapView.getMap().move(
                        ...
                        null);
                MakeRouteRequest(location.getPosition(), CM_LOCATION, "Central Market");
            }
            @Override
